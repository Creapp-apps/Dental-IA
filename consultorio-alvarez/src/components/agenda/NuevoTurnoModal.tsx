    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex w-full items-center justify-between rounded-lg border border-input px-3 py-2 text-sm bg-input/40 hover:bg-input/60 focus:ring-2 focus:ring-ring/50 transition-all outline-none text-foreground"
            >
                ...
                {open && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute top-full left-0 w-full mt-1.5 z-[99999] bg-popover text-popover-foreground shadow-[0_15px_35px_rgba(0,0,0,0.85)] rounded-xl p-1.5 overflow-y-auto max-h-[250px] border border-border backdrop-blur-xl custom-scrollbar"
                        >
                            {options.map(o => (
                                <button
                                    key={o.value}
